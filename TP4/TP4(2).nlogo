...
to change-work
  if ctask != "back-from-hunt" and ctask != "back-from-gathering" and 1 > random 1000
  [
    ifelse hunt-total-energy / ( count hunters with [ ctask = "hunt" or ctask = "back-from-hunt" ] + 1 ) > gathering-total-energy / ( count hunters with [ ctask = "gather" or ctask = "back-from-gathering" ] + 1 )
    [
      set ctask "hunt" 
      set color pink
    ]
